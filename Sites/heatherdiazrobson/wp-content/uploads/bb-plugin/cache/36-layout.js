...
var wpAjaxUrl='http://localhost:8888/heatherdiazrobson/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost:8888/heatherdiazrobson/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://localhost:8888/heatherdiazrobson/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://localhost:8888/heatherdiazrobson/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
else if(this.settings.layout=='gallery'){this.gallery.resize();elements.css('visibility','visible');}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'582fbfad83623',layout:'grid',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:0});});$(window).on('load',function(){$('.fl-node-582fbfad83623 .fl-post-grid').masonry('reloadItems');});})(jQuery);